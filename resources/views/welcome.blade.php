    ...
    <header class="main-header">
        ...
        <div class="header-container">
            ...
            <div class="authorization-block">
                ...
                <a href="{{ route('login') }}" class="authorization-block__link">{{ __('Login') }}</a>
                @endauth
                @guest

                @else
                    <a class="authorization-block__link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
